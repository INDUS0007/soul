...
from .views import (
    ...
    AffirmationAdminView,
    AffirmationBulkCreateView,
    LegacyAssessmentView,
    LegacyBreathingView,
    BreathingSessionListCreateView,
    BreathingSessionDetailView,
    LegacyExpertConnectView,
    LegacyFeatureDetailView,
    LegacyGuidelinesView,
    MeditationSessionListView,
...
urlpatterns = [
    ...
    path("wellness/tasks/", WellnessTaskListCreateView.as_view()),
    path("wellness/tasks/<int:task_id>/", WellnessTaskDetailView.as_view()),
    path("wellness/journals/", MyJournalListCreateView.as_view()),
    path("wellness/journals/<int:pk>/", MyJournalDetailView.as_view()),
    path("support-groups/", SupportGroupListView.as_view()),
    path("sessions/", UpcomingSessionListCreateView.as_view()),
    path("sessions/<int:session_id>/", UpcomingSessionDetailView.as_view()),
    path("sessions/<int:session_id>/start/", SessionStartView.as_view()),
    ...
    path("breathing/sessions/", BreathingSessionListCreateView.as_view()),
    path("breathing/sessions/<int:pk>/", BreathingSessionDetailView.as_view()),
    # Affirmation endpoints
    path("affirmations/", AffirmationListView.as_view()),
    path("affirmations/<int:pk>/", AffirmationDetailView.as_view()),
    path("affirmations/admin/", AffirmationAdminView.as_view()),
    path("affirmations/admin/bulk/", AffirmationBulkCreateView.as_view()),
    # Counselor endpoints
    path("counselor/profile/", CounsellorProfileView.as_view()),
    path("counselor/appointments/", CounsellorAppointmentsView.as_view()),
    path("counselor/stats/", CounsellorStatsView.as_view()),
